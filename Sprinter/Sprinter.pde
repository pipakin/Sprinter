  ...
  else if(code_seen('M'))
  {
    ...
    switch( (int)code_value() ) 
    {
      ...
      case 105: // M105
          ...
          #ifdef PIDTEMP
            SerialMgr.cur()->print(" @:");
            SerialMgr.cur()->print(heater_duty); 
            SerialMgr.cur()->print(",");
	...
	SerialMgr.cur()->print("E:");
      ...
      case 119: // M119
        ...
        SerialMgr.cur()->print((READ(X_MIN_PIN)^X_ENDSTOP_INVERT)?"H ":"L ");
      	#endif
      	#if (X_MAX_PIN > -1)
      	SerialMgr.cur()->print("x_max:");
        SerialMgr.cur()->print((READ(X_MAX_PIN)^X_ENDSTOP_INVERT)?"H ":"L ");
      	#endif
      	#if (Y_MIN_PIN > -1)
      	SerialMgr.cur()->print("y_min:");
        SerialMgr.cur()->print((READ(Y_MIN_PIN)^Y_ENDSTOP_INVERT)?"H ":"L ");
      	#endif
      	#if (Y_MAX_PIN > -1)
      	SerialMgr.cur()->print("y_max:");
        SerialMgr.cur()->print((READ(Y_MAX_PIN)^Y_ENDSTOP_INVERT)?"H ":"L ");
      	#endif
      	#if (Z_MIN_PIN > -1)
      	SerialMgr.cur()->print("z_min:");
        SerialMgr.cur()->print((READ(Z_MIN_PIN)^Z_ENDSTOP_INVERT)?"H ":"L ");
      	#endif
      	#if (Z_MAX_PIN > -1)
      	SerialMgr.cur()->print("z_max:");
        SerialMgr.cur()->print((READ(Z_MAX_PIN)^Z_ENDSTOP_INVERT)?"H ":"L ");
      	#endif
        SerialMgr.cur()->println("");
      	break;
      #ifdef RAMP_ACCELERATION
